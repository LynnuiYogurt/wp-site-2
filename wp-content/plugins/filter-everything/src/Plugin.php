    ...
    public function includeFrontJs()
    {
        ...
        wp_localize_script( 'wpc-filter-everything', 'wpcFilterFront',
            array(
                ...
                'wpcNoPostsContainerMsg'     => esc_html__('It appears that this page does not contain a container with the specified «CSS id or class of the Posts Container». Try to specify the correct one in the Filter Set settings or the common plugin Settings.', 'filter-everything'),
            )
        );
    }
